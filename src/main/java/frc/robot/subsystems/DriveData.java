...
public class DriveData {
    ...
    public final WPI_VictorSPX frontLeftDrive = new WPI_VictorSPX(Constants.Drive.FRONT_LEFT_PORT);
    public final WPI_VictorSPX frontRightDrive = new WPI_VictorSPX(Constants.Drive.FRONT_RIGHT_PORT);
    public final WPI_VictorSPX backLeftDrive = new WPI_VictorSPX(Constants.Drive.BACK_LEFT_PORT);
    public final WPI_VictorSPX backRightDrive = new WPI_VictorSPX(Constants.Drive.BACK_RIGHT_PORT);
